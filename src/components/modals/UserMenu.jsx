...
const UserMenu = ({ currentUser, showUserMenu, setShowUserMenu }) => {
  return (
    <>
      {showUserMenu && <div
        className="fixed inset-0 bg-gradient-to-r from-primary-light/10 to-primary-light/20 backdrop-blur-sm z-20 transition-opacity duration-300"
        onClick={() => setShowUserMenu(false)}
      />}
      <div onClick={e => e.stopPropagation()} className="absolute right-0 top-[100%] mt-4 w-64 bg-tetiary rounded-xl shadow-lg border border-primary/20 py-2 z-30">
