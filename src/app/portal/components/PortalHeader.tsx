      ...
      <div className="flex items-center justify-between h-16 px-6">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-3">
            <Link
              href="/"
              className="font-bold text-tetiary text-lg bg-linear-to-r from-tetiary/60 to-tetiary/70 rounded-lg py-1 px-2 shadow-md"
            >
              <Image src={'/Bismak.svg'} alt="Bismak logo" width={160} height={80}/>
            </Link>
          </div>
        </div>
