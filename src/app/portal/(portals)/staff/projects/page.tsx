...
import { FaProjectDiagram, FaTelegram } from "react-icons/fa";
import DashboardStatsCard from "../../../components/DashBoardStatsCard";
import { getProgressPercentage, getStatusColor, PROJECT_REQUESTS, staffProjectStats } from "../../../constants";
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row items-center justify-between bg-linear-to-r from-primary/10 to-secondary/10 shadow-md hover:shadow-lg p-4 rounded-2xl w-full transition-all duration-300">
        ...
        <div>
          <PrimaryButton tittle={"Submit Project"} icon={<FaTelegram />} />
        </div>
      </div>
