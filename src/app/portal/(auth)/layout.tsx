...
export default function LoginLayout({
 ...
 const pathname = usePathname();
  ...
  return <div className="min-h-screen flex items-center justify-center bg-primary/20 sm:p-20">
      <div className="grid md:grid-cols-2 w-full max-w-5xl sm:rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-4 sm:p-10 flex flex-col justify-center bg-tetiary">
          ...
          <div className="flex gap-3 mb-6">
            {[
              { id: "client", icon: <FaUserShield />, label: "Client Portal" },
              { id: "staff", icon: <FaUserTie />, label: "Staff Portal" },
              { id: "admin", icon: <FaUserShield />, label: "Admin Portal" },
            ].map((p) => (
              <button
                key={p.id}
                type="button"
